---
title: "Estimates of Wenatchee Steelhead Redds in 2020"
author:
  - Kevin See:
...
load('../data/derived_data/wen_2019.rda')
...
spwn_strm = escp_wen %>%
  ...
  mutate(Location = recode(Location,
         ...
         Location = factor(Location, levels = c('Below_TUM',
                                                'TUM_bb',
                                                'Icicle', 
                                                'Peshastin', 
                                                'Mission', 
...
```{r gauc-plots, eval = F, fig.cap = "Plots of observed redd counts (black dots) through time for each qualifying index reach, and the fitted curve from the GAUC model (blue line) with associated uncertainty (gray)."}
redd_results %>%
  filter(GAUC) %>%
