---
title: "Estimates of Wenatchee Steelhead Redds in 2013"
author:
  - Kevin See:
...
```{r load-data}
org_data = read_rds('../data/derived_data/one_obs_original_data.rds')
net_err_mod = read_rds('../data/derived_data/one_obs_net_error_model.rds')

load('../data/derived_data/wen_2013.rda')
