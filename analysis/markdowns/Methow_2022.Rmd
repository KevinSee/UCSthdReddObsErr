  ...
  mutate(Location = factor(Location, 
         ...
         across(River,
                ...
                levels = c("Methow",
                           ...
                           "Spring Creek",
                           "Beaver"))) %>%
  arrange(River, Location, Reach, Type) %>%
...
Within the Methow, there are two types of hatchery fish: safety net (HOR-SN) and conservation (HOR-C). These are distinguished by different marks. Safety net fish are ad-clipped but do not have a coded wire tag (CWT), whereas conservation fish may or may not be ad-clipped, but do have a CWT implanted. Fish determined to be hatchery (from scales), but were not designated as ad-clipped or having a CWT were considered conservation fish.  
