...
expn_df %>%
  ...
  kable(booktabs = T,
        linesep = "",
        digits = 3,
        caption = "Mean proportion of total spawners within the Wenatchee basin estimated to have moved into Chiwaukum, Chumstick and Mission creeks, by origin, with standard error. Proportion in 2011 is only for Mission Creek.") %>%
